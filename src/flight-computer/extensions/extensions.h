...
class PRESS_SENSOR_SIM : public Extension {
 public:
    PRESS_SENSOR_SIM(DataStream *p_data_stream, ExtensionMetadata extension_metadata);
    ~PRESS_SENSOR_SIM();
    int runner();
 ...
 private:
    ...
    float pressure_delta_up_ = (landing_pressure_ - apogee_pressure_) / seconds_to_apogee_;
    float pressure_delta_down_ = (apogee_pressure_ - landing_pressure_) / seconds_to_landing_;
};

class TEMP_SENSOR_SIM :public Extension {
  public:
  TEMP_SENSOR_SIM(DataStream *p_data_stream, ExtensionMetadata extension_metadata);
  ~TEMP_SENSOR_SIM();
  int runner();
};
...
class BATT_SENSOR_SIM :public Extension {
  public:
  BATT_SENSOR_SIM(DataStream *p_data_stream, ExtensionMetadata extension_metadata);
  ~BATT_SENSOR_SIM();
  int runner();
};
