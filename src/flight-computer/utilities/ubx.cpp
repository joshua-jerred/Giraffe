...
int ubx::getStreamSize(extension_interface::I2C &i2c) {
    if (i2c.status() != extension_interface::I2C_STATUS::OK) {
        i2c.connect();
        if (i2c.status() != extension_interface::I2C_STATUS::OK) {
...
bool ubx::flushStream(extension_interface::I2C &i2c) {
...
*/
bool ubx::readNextUBX(extension_interface::I2C &i2c, ubx::UBXMessage &message) {
...
bool ubx::readSpecificMessage(extension_interface::I2C &i2c, ubx::UBXMessage &message) {
...
bool ubx::writeUBX(extension_interface::I2C &i2c, const ubx::UBXMessage &message) {
...
ubx::ACK ubx::checkForAck(extension_interface::I2C &i2c, const uint8_t msg_class, const uint8_t msg_id) {
...
*/
bool ubx::sendResetCommand(extension_interface::I2C &i2c) {
...
*/
ubx::ACK ubx::setProtocolDDC(extension_interface::I2C &i2c, const bool extended_timeout) {
    static const uint8_t kMessageClass   = 0x06; // CFG
 ...
 * @see 32.10.18.3
*/
ubx::ACK ubx::setMessageRate(extension_interface::I2C &i2c, uint8_t msg_class, uint8_t msg_id, uint8_t rate) {
    static const uint8_t kMessageClass   = 0x06; // CFG
...
ubx::ACK ubx::setMeasurementRate(extension_interface::I2C &i2c, const uint16_t rate_ms) {
    static const uint8_t kMessageClass   = 0x06; // CFG
...
ubx::ACK ubx::setDynamicModel(extension_interface::I2C &i2c, const ubx::DYNAMIC_MODEL model) {
    static const uint8_t kMessageClass   = 0x06; // CFG
 ...
 * payload.
*/
bool ubx::pollMessage(extension_interface::I2C &i2c,
        ubx::UBXMessage &message,
