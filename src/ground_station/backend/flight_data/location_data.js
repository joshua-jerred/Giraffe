...
module.exports = class LocationData {
  constructor(global_state) {
    ...
    this.last_known_position = LocationStructure;
  ...
  cycle() {
    ...
    this.ground_station_position.latitude = this.global_state.ggs_db.get(
      "settings",
      "ggs_settings",
      "ground_station_position_latitude"
    );
    this.ground_station_position.longitude = this.global_state.ggs_db.get(
      "settings",
      "ggs_settings",
      "ground_station_position_longitude"
    );
  }
  ...
  getData() {
    let return_data = {
      ...
      last_known_position: this.last_known_position,
