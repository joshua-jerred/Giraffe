...
extension::BME280::BME280(DataStream *p_data_stream,
    ...
    : Extension(p_data_stream, extension_metadata),
      ...
      i2c_bus_(interface::I2C(bus_number_, device_address_,
                              p_data_stream->getI2CBusLock()))
...
int extension::BME280::configure() {
  ...
  const uint8_t kTempAndPressureSettings =
  ...
  write_result =
      i2c_bus_.writeByteToReg(kReg_Ctrl_Meas, kTempAndPressureSettings);
  if (write_result != 0) {
    return -1;
  }
...
int extension::BME280::readCompensationData() {
  ...
  bytes_read = i2c_bus_.readChunkFromReg(
      data_section1, kCalibrationDataLength_sec1, kCalibrationDataHead_sec1);
  if (bytes_read != kCalibrationDataLength_sec1) {
    return -1;
  }

  bytes_read = i2c_bus_.readChunkFromReg(
      data_section2, kCalibrationDataLength_sec2, kCalibrationDataHead_sec2);
...
int extension::BME280::processData() {
  ...
  tvar1 = ((((raw_data_.temperature >> 3) -
           ...
           ((int32_t)temp_comp_data_.dig_T2)) >>
          11;
  tvar2 =
      (((((raw_data_.temperature >> 4) - ((int32_t)temp_comp_data_.dig_T1)) *
         ((raw_data_.temperature >> 4) - ((int32_t)temp_comp_data_.dig_T1))) >>
        12) *
       ((int32_t)temp_comp_data_.dig_T3)) >>
      14;
  ...
  pvar1 =
      (((((int64_t)1) << 47) + pvar1)) * ((int64_t)press_comp_data_.dig_P1) >>
      33;
  if (pvar1 == 0) {
    error("DIV0");
    return -1;
  ...
  h = (((((raw_data_.humidity << 14) -
          (((int32_t)hum_comp_data_.dig_H4) << 20) -
          (((int32_t)hum_comp_data_.dig_H5) * h)) +
         ((int32_t)16384)) >>
        15) *
       (((((((h * ((int32_t)hum_comp_data_.dig_H6)) >> 10) *
           ...
           10) +
          ((int32_t)2097152)) *
             ((int32_t)hum_comp_data_.dig_H2) +
         8192) >>
        14));
  h = (h -
       (((((h >> 15) * (h >> 15)) >> 7) * ((int32_t)hum_comp_data_.dig_H1)) >>
        4));
  h = (h < 0) ? 0 : h;
