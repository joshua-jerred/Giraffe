...
const std::unordered_map<DiagnosticId, std::string> K_DIAGNOSTIC_ID_STRING_MAP {
  ...
  {DiagnosticId::EXTENSION_MODULE_invalidExtensionType,"EXTENSION_MODULE_invalidExtensionType"},
  {DiagnosticId::EXTENSION_MODULE_internalError,"EXTENSION_MODULE_internalError"},
  {DiagnosticId::EXTENSION_MODULE_extensionErrorDisabled,"EXTENSION_MODULE_extensionErrorDisabled"},
