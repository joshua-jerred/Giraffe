...
inline constexpr static int GDL_THREAD_SLEEP_INTERVAL_MS = 200;
...
inline constexpr static uint32_t GDL_RDT_RETRY_INTERVAL_MS = 5000;
inline constexpr static uint32_t GDL_CONNECTION_STATUS_INTERVAL_MS = 120 * 1000;

inline constexpr static uint32_t GDL_EXCHANGE_CONNECTION_TIMEOUT_MS = 30 * 1000;

/// @brief If we don't have an exchange message within this time, we will send a
/// ping to check the connection.
inline constexpr static uint32_t GDL_EXCHANGE_PING_INTERVAL_MS = 5 * 1000;
