...
struct GpsFrame {
  ...
  bst::clck::TimePoint gps_utc_time = bst::clck::TimePoint();

  /// @brief This is generated by the extension, the data may still not be
  /// reliable.
  bool is_valid = false;
...
struct ImuFrame {
   ...
   */
  bst::clck::TimePoint time = bst::clck::now();
