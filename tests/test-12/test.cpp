 ...
 * @brief Tests for the MAX17049 fuel gauge IC extension/driver
 * @date 2022-12-30
...
class MAX17049Test : public ::testing::Test {
protected:
    virtual void SetUp() { 
...
TEST_F(MAX17049Test, MAX17049Test1) {
    extension::MAX17049 max17049(p_data_stream_, extension_metadata_);
    max17049.start();
    sleep(1);
    max17049.stop();
