...
- try to assign dumped string to a class member variable [\#3300](https://github.com/nlohmann/json/issues/3300)
...
- Parsing an empty string returns a string with size 1 instead of expected 0 [\#3057](https://github.com/nlohmann/json/issues/3057)
...
- Cannot serialize and immediately deserialize json to/from bson [\#2892](https://github.com/nlohmann/json/issues/2892)
...
- "Custom data source" example make no sense [\#2423](https://github.com/nlohmann/json/issues/2423)
...
- Suppress -Wfloat-equal on intended float comparisons [\#2911](https://github.com/nlohmann/json/pull/2911) ([Finkman](https://github.com/Finkman))
...
- Use unsigned indices for array index in json pointer [\#2203](https://github.com/nlohmann/json/pull/2203) ([t-b](https://github.com/t-b))
...
- Fix consistency in function `int_to_string()` [\#2193](https://github.com/nlohmann/json/pull/2193) ([data17](https://github.com/dota17))
- Fix issue\#1275 [\#2181](https://github.com/nlohmann/json/pull/2181) ([data17](https://github.com/dota17))
...
- Can't ad an object in another object [\#2101](https://github.com/nlohmann/json/issues/2101)
...
- why static function `parse` can't find in visual studio 2019 [\#1894](https://github.com/nlohmann/json/issues/1894)
...
- conflict with g++ compile option -mwindows [\#1860](https://github.com/nlohmann/json/issues/1860)
...
- Fix PR\#1006 [\#2158](https://github.com/nlohmann/json/pull/2158) ([data17](https://github.com/dota17))
- Fix issue\#1972 [\#2153](https://github.com/nlohmann/json/pull/2153) ([data17](https://github.com/dota17))
...
- Fix issue 2112 [\#2137](https://github.com/nlohmann/json/pull/2137) ([data17](https://github.com/dota17))
...
- Fix issue\#2086: disallow json::value\_t type parameter in value\(\) [\#2104](https://github.com/nlohmann/json/pull/2104) ([data17](https://github.com/dota17))
...
- Fix issue\#1719 [\#2044](https://github.com/nlohmann/json/pull/2044) ([data17](https://github.com/dota17))
- Add missing testcase about NaN in unit-constructor1.cpp [\#2043](https://github.com/nlohmann/json/pull/2043) ([data17](https://github.com/dota17))
...
- fix \#1982:json\_pointer.contains\(\) exception is incorrectly raised [\#2019](https://github.com/nlohmann/json/pull/2019) ([data17](https://github.com/dota17))
...
- catch exceptions for json\_pointer : ..../+99 [\#1990](https://github.com/nlohmann/json/pull/1990) ([data17](https://github.com/dota17))
- Modify the document about operator== [\#1984](https://github.com/nlohmann/json/pull/1984) ([data17](https://github.com/dota17))
...
- fix warnings in serializer.hpp for VS2019 [\#1969](https://github.com/nlohmann/json/pull/1969) ([data17](https://github.com/dota17))
- Fix C26451 warnnings in to\_chars.hpp [\#1967](https://github.com/nlohmann/json/pull/1967) ([data17](https://github.com/dota17))
...
- Fix typo in examples [\#1956](https://github.com/nlohmann/json/pull/1956) ([data17](https://github.com/dota17))
- templated input adapters [\#1950](https://github.com/nlohmann/json/pull/1950) ([FrancoisChabot](https://github.com/FrancoisChabot))
- Update README.md : add a FAQ about memory release [\#1933](https://github.com/nlohmann/json/pull/1933) ([data17](https://github.com/dota17))
...
- De/Serialisation of vector of tuple object with nested object need Help please [\#1794](https://github.com/nlohmann/json/issues/1794)
...
- pass a json object to a class constructor adds an array around the object [\#1776](https://github.com/nlohmann/json/issues/1776)
...
- How can I retrieve unknown strings from json file in my C++ program. [\#1684](https://github.com/nlohmann/json/issues/1684)
...
- Updating from an older version causes problems with assign a json object to a struct [\#1630](https://github.com/nlohmann/json/issues/1630)
...
- program crash everytime, when other data type incoming in json stream as expected [\#1612](https://github.com/nlohmann/json/issues/1612)
...
- got an error and can't figure it out [\#1351](https://github.com/nlohmann/json/issues/1351)
...
- Json Library is not responding for me in c++ [\#1332](https://github.com/nlohmann/json/issues/1332)
...
- How to convert JSON to Struct with embedded subject [\#1310](https://github.com/nlohmann/json/issues/1310)
...
- Two backslashes on json output file [\#1253](https://github.com/nlohmann/json/issues/1253)
...
- Template instantiation error on compiling [\#1203](https://github.com/nlohmann/json/issues/1203)
...
- Use a version check to provide backwards compatible CMake imported target names [\#1245](https://github.com/nlohmann/json/pull/1245) ([chuckatkins](https://github.com/chuckatkins))
...
- Feature request :: Better testing for key existence without try/catch [\#1074](https://github.com/nlohmann/json/issues/1074)
...
- Is it possible to use exceptions instead of assertions? [\#1056](https://github.com/nlohmann/json/issues/1056)
...
- Destructor is called when filling object through assignment [\#1050](https://github.com/nlohmann/json/issues/1050)
...
- Typo "exception" [\#869](https://github.com/nlohmann/json/issues/869)
...
- Gtest SHE Exception [\#709](https://github.com/nlohmann/json/issues/709)
...
- How to construct an iterable usage in nlohmann json? [\#636](https://github.com/nlohmann/json/issues/636)
...
- Why not also look inside the type for \(static\) to\_json and from\_json functions? [\#511](https://github.com/nlohmann/json/issues/511)
...
- REFACTOR: rewrite CMakeLists.txt for better include and reuse [\#669](https://github.com/nlohmann/json/pull/669) ([dan-42](https://github.com/dan-42))
...
- Fixing assignment for iterator wrapper second, and adding unit test [\#579](https://github.com/nlohmann/json/pull/579) ([Type1J](https://github.com/Type1J))
...
- Question on the lifetime management of objects at the lower levels [\#449](https://github.com/nlohmann/json/issues/449)
...
- make check compilation is unnecessarily slow [\#445](https://github.com/nlohmann/json/issues/445)
...
- std::unordered\_map cannot be used as ObjectType [\#164](https://github.com/nlohmann/json/issues/164)
...
- Preserving order of items in json [\#262](https://github.com/nlohmann/json/issues/262)
...
- JSON performance benchmark comparison [\#177](https://github.com/nlohmann/json/issues/177)
